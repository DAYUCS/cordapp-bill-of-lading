...
import com.example.contract.BLContract.Companion.BL_CONTRACT_ID
...
object ExampleFlow {
    ...
    class Initiator(val blState: BLState,
        ...
        override fun call(): SignedTransaction {
            ...
            val txBuilder = TransactionBuilder(notary).withItems(StateAndContract(blState, BL_CONTRACT_ID), txCommand)
